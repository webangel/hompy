...
import { getAllStoresAction } from "../redux/actions/storesActions";
          ...
          actions={[
            {
              ...
              tooltip: "Edit user",
              onClick: (_, rowData) =>
                alert("Editando tienda con ID: " + rowData.id),
            },
            {
              icon: LaunchIcon,
              tooltip: "Visit store",
...
const Container = styled.div`
  ...
  .MuiPaper-root ul,
  .MuiList-padding {
    background-color: ${(props) => props.theme.TABLE_HEADER_BACKGROUND_COLOR};
